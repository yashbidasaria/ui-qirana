...
app.controller("buyer2", ['$scope', '$rootScope', 'shared', '$routeParams', '$http',
    ...
    var crashQ = function (q){
        ...
        if(q.value == 'q3') {
            str += '&state=' + $scope.selectedstate.value + '&crash_date=' + $scope.selecteddate.value + '&interval=' + $scope.selectedmonth
        };
        if(q.value == 'q4') {
    ...
    var dblpQ = function (q){
        ...
        if(q.value == 'q2') {
            str += '&fromnodeid=' + $scope.selectedFrom1 + '&fromnodeid=' + $scope.selectedFrom2
        };
        $http({
            method: "GET",
